    ...
    <div v-else class="deck-grid">
      ...
      >
        ...
        <div class="deck-menu" v-if="editingDeck !== deck.id">
          <button @click.stop="startEdit(deck.id!, deck.title)" class="btn-icon" title="Umbenennen">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M11 4H4a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2v-7"></path>
              <path d="M18.5 2.5a2.121 2.121 0 013 3L12 15l-4 1 1-4 9.5-9.5z"></path>
            </svg>
          </button>
          <button @click.stop="deleteDeck(deck.id!, deck.title)" class="btn-icon btn-delete" title="Löschen">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          ...
          <div class="deck-info">
            <div v-if="editingDeck === deck.id" class="edit-form">
              ...
              <div class="edit-actions">
                <button @click.stop="saveEdit(deck.id!)" class="btn-icon btn-save">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <polyline points="20 6 9 17 4 12"></polyline>
                  </svg>
                </button>
                <button @click.stop="cancelEdit" class="btn-icon btn-cancel">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <div class="deck-actions">
          <RouterLink @click.stop :to="`/decks/${deck.id}`" class="btn btn-secondary">
            Bearbeiten
          </RouterLink>
          <RouterLink
            @click.stop
...
.deck-card {
  ...
  box-shadow: 0 4px 20px rgba(0, 0, 0, 0.04);
  cursor: pointer; /* <-- neu: macht klar klickbar */
}
